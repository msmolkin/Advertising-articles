...
class GPTAsker:
    ...
    def copy_parsed_response(self):
        ...
        print("Copying the title to the clipboard clipboard. Please press Enter/return key to continue...")
        input()
        pyperclip.copy(self.parsed_response["title"])

        print("Copying the abstract to the clipboard. Please press Enter/return key to continue...")
        input()
        pyperclip.copy(self.parsed_response["abstract"])

        print("Copying the summary to the clipboard. Please press Enter/return key to continue...")
        input()
